                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                       ...
                       <%-- <div class="col-xs-4">
                            <div class="form-group">
                                <label class="control-label col-sm-4" title="">
                                    <span class="required hide" aria-required="true">*</span> 流水号：<i class="fa icon-question hide"></i></label>
                                <div class="col-sm-8">
                                    <input type="text" id="serialNumber" name="serialNumber" value="${student.serialNumber}" class="form-control">
                                </div>
                            </div>
                        </div>--%>
