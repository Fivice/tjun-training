        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="input-group">
                    <input type="text" class="form-control" name="startStopTime" id="startStopTime" placeholder="请选择开班时间段" value="${startStopTime}">
                </div>
            </div>
        ...
        <div class="modal right fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer right" style="height: 50px;bottom: 0px;padding: 8px 30px;width: 100%;background-color: #333;border-top-color: #333">
...
<%--js for this page--%>
<script src="${ctxsta }/entity/classFunds/classFundsMobile.js"></script>
