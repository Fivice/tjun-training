...
<body>
  <div class="ibox-content">
    <form id="form" class="form-horizontal"  data-method="post">
      ...
      <input type="hidden" class="form-control" name="areaType" value="${unit.areaType==1?2:3}">
      <input type="hidden" class="form-control" name="sjareaId" value="${unit.areaId}">

      <div class="form-group m-t">
        <label class="col-sm-2 col-xs-offset-1 control-label">上级单位：</label>
        <div class="col-sm-7">
          <input type="text" class="form-control" placeholder="${unit.areaName}${areaName}" disabled>
        </div>
      </div>
