...
<div class="container" style="padding-right: 5px;padding-left: 5px">
    <div>
        <div class="panel panel-default">
            <div class="panel-body" style="margin: 10px 1px">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="height: calc(100% - 106px);min-height: 450px">
                        ...
                        <hr/>
                        <div class="btn-group m-t-sm">
                            <p style="font-weight: bolder;margin-bottom: 5px">班主任:</p>
                            <input type="text" class="form-control" name="teacherName" id="teacherName" placeholder="请输入班主任" >
                        </div>
