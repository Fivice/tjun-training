...
<div class="ibox-content">
    <form id="form" class="form-horizontal"  data-method="post">
        <input type="hidden" name="tiId" value="${teacherInfo.tiId}" />
        <div class="form-group m-t">
            <label class="col-sm-2 control-label">姓名<span
                    class="red_must">*</span></label>
            <div class="col-sm-8">
                <input type="text" class="form-control" value="${teacherInfo.name}" name="name"
                       placeholder="请输入姓名">
            </div>
        </div>
        ...
        <div class="form-group m-t">
            <label class="col-sm-2 control-label">电话号码<span
                    class="red_must">*</span></label>
            <div class="col-sm-8">
                <input type="text" class="form-control" value="${teacherInfo.phoneNumber}" name="phoneNumber"
                       placeholder="请输入电话号码">
            </div>
        </div>
        <div class="hr-line-dashed"></div>
        ...
        <div class="form-group m-t">
            <label class="col-sm-2 control-label">工作单位<span
                    class="red_must">*</span></label>
            <div class="col-sm-8">
                <input type="text" class="form-control" value="${teacherInfo.tiDepartment}" name="tiDepartment"
                       placeholder="请输入工作单位">
            </div>
        </div>
        <div class="hr-line-dashed"></div>
        <div class="form-group m-t">
            ...
            <div class="col-sm-8">
                ...
                <input type="text" class="form-control" value="${teacherInfo.subject}" name="subject"
                       placeholder="请输入授课科目">
            </div>
        </div>
    </form>
