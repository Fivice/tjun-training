...
<html>
<head>
    <script src="${ctxsta }/entity/teachDinFaceRecord/teachDinFaceRecordTable.js"></script>
</head>
                    ...
                    <div class="ibox-content">
                        <div class="row row-lg">
                            <div class="col-sm-12">
                                ...
                                <input type="hidden" id="classId" name="teacherId" value="${classId}">
                                <table id="teach_dining_face_record" class="table table-bordered table-striped"></table>
                            </div>
                        </div>
