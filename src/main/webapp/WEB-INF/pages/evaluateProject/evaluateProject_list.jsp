...
<head>
    ...
    <script> var t1 = new Date().getTime();
    baselocation = '${ctximg}';
    imagelocation = '${ctximg}/uploads';</script>
                        ...
                        <div class="row row-lg">
                            <div class="col-sm-12">
                                ...
                                <%--<div class="btn-group m-t-sm">
                                    <button type="button" class="btn btn-default" title="创建"
                                            onclick="layer_show('添加评价项目','${ctx}/evaluate/add/view.action','900','480')">
                                        <i class="glyphicon glyphicon-plus"></i></button>
                                </div>
                                <div class="btn-group m-t-sm">
                                    <button type="button" class="btn btn-default" title="编辑" onclick="evaluate_edit()">
                                        <i class="glyphicon glyphicon-pencil"></i></button>
                                </div>--%>
                                <%--<div class="btn-group m-t-sm">
                                    <button type="button" class="btn btn-default" title="删除" onclick="evaluate_delete()"
                                            id="del"><i class="glyphicon glyphicon-minus"></i></button>
                                </div>--%>
                                <div class="btn-group m-t-sm" style="margin-left: 50px;">
                                    <span class="select_lr_style">评价选项 ：</span>
                                    <select id="sl" class="selectpicker" name="largeClass" data-live-search="true"
                                            onchange="findTable(this.value)" style="width:150px;height:35px;">
                                ...
                                <table id="table_evaluate_project" class="table table-bordered table-striped"></table>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    function findTable(value) {
        $("#table_evaluate_project").bootstrapTable('refresh');//表单刷新
    }
</script>
<script src="${contextPath }/static/cms/js/evaluateProject/evaluateProject.js"></script>
