$(function() {
    // 1.初始化Table
    var oTable = new DiningInfoTableInit();
    oTable.Init();

    // 2.初始化Button的点击事件
    var oButtonInit = new DiningInfoButtonInit();
    oButtonInit.Init();
});
//
var DiningInfoTableInit = function() {
    ...
    oTableInit.Init = function() {
        $('#stu-dining-table')
            .bootstrapTable(
                {
                    url : basePath+'/remoteOperate/studentDiningInfo.action', // 请求后台的URL（*）
                    method : 'get', // 请求方式（*）
...
var DiningInfoButtonInit = function() {
