...
var teacheDingTable = function() {
    //初始化Table
    var oTable = new teacheDinTable();
    oTable.Init();
};
    ...
    oTableInit.Init = function () {
        $('#teachDinTable').bootstrapTable({
            ...
            columns: [
                ...
                {title: '应到人次', field: 'list.dBreakfast',valign:"middle",align:"center"
                ...
                {title: '实到人次', field: 'list.rBreakfast',valign:"middle",align:"center"},
                ...
                {title: '实到人次', field: 'list.rLunch',valign:"middle",align:"center"},
                ...
                {title: '实到人次', field: 'list.rDinner',valign:"middle",align:"center"},
