    ...
    oTableInit.Init = function () {
        $('#stuDinTable').bootstrapTable({
            ...
            columns: [
                ...
                {title: '应到人次', field: 'sdrlVO.dBreakfast', valign:"middle",align:"center"
                ...
                {title: '实到人次', field: 'sdrlVO.rBreakfast',valign:"middle",align:"center"
                    ,formatter:function(value){
                        if(value==null){
                            return "0";
                        }else {
                ...
                {title: '应到人次', field: 'sdrlVO.dLunch',valign:"middle",align:"center"
                    ,formatter:function(value){
                        if(value==null){
                            return "0";
                        }else {
                ...
                {title: '实到人次', field: 'sdrlVO.rLunch',valign:"middle",align:"center"
                    ,formatter:function(value){
                        if(value==null){
                            return "0";
                        }else {
                ...
                {title: '应到人次', field: 'sdrlVO.dDinner',valign:"middle",align:"center"
                    ,formatter:function(value){
                        if(value==null){
                            return "0";
                        }else {
                ...
                {title: '实到人次', field: 'sdrlVO.rDinner', valign:"middle",align:"center"
                    ,formatter:function(value){
                        if(value==null){
                            return "0";
                        }else {
