...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#stud_dining_record').bootstrapTable({
            ...
            exportOptions: {
                ...
                fileName: '学员就餐记录列表详情',              //文件名称设置
                worksheetName: 'Sheet1',          //表格工作区名称
                tableName: '学员就餐记录列表详情',
                excelstyles: ['background-color', 'color', 'font-size', 'font-weight'],
                //onMsoNumberFormat: DoOnMsoNumberFormat
            }
            //导出excel表格设置<<<<<<<<<<<<<<<<
...
function search() {
    $("#stud_dining_record").bootstrapTable('refresh');
    $('#stud_dining_record').bootstrapTable('selectPage', 1);
}
