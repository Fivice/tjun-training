...
var TableInit = function() {
    ...
    oTableInit.Init = function() {
        $('#table')
            .bootstrapTable(
                {
                    url : 'findTeacherEvaluationTable.action', // 请求后台的URL（*）
                    method : 'post', // 请求方式（*）
                    ...
                    columns : [
                        ...
                        {title: '课程名称', field: '',formatter:function (value, row, index) {
                                return row.subjTeachEvaluateVo.schedulingContent+" [ "+row.subjTeachEvaluateVo.teacher+" ]"
                            }},
                        {title: '评分', field: 'subjTeachEvaluateVo.result', formatter:function(value){
