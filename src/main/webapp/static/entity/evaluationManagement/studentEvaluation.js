...
var TableInit = function() {
    ...
    oTableInit.Init = function() {
        $('#table')
            .bootstrapTable(
                {
                    url : 'findStudentTable.action', // 请求后台的URL（*）
                    method : 'post', // 请求方式（*）
                    ...
                    columns : [
                        ...
                        {title: '学员姓名', field: 'student.siName'},
                        {title: '手机', field: 'student.phoneNumber'},
                        {title: '评价', field: 'register.status',formatter : function(value, row, index) {
                                var front_color;
                                if (value == "1") {
                                    front_color = 'green';
                                    return "<span class='label label-primary'>已评价</span>";
                                }
                                if (value == "0") {
                                    return "<span class='label label-warning'>未评价</span>";
                                }
                                return "";
                            }}
