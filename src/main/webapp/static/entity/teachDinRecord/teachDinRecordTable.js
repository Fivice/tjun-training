...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $('#teach_dining_record').bootstrapTable({
            ...
            columns: [
                {title: '日期', field: 'teacherDay', sortable: true},
                {title: '星期', field: 'teacherDay',formatter : function(value, row, index) {
...
function search() {
    $("#teach_dining_record").bootstrapTable('refresh');
    $('#teach_dining_record').bootstrapTable('selectPage', 1);
}
