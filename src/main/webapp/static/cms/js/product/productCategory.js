...
window.actionEvents = {
	...
	'click .edit' : function(e, value, row, index) {
		layer_show(row.name, baselocation + '/product/category/' + row.categoryId + '/edit', 900, 480)
	},
	'click .remove' : function(e, value, row, index) {
		admin_delete(index, row.categoryId);
	},
	'click .log' : function(e, value, row, index) {
		layer_show(row.name, baselocation + '/product/category/' + row.categoryId + '/create', 900, 480)
	}
};
